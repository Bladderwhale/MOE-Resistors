...
demo.state3.prototype = {resistors:{},
    ...
    create: function(){
        ...
        this.txtDesc.align = "left";
        this.txtDesc.position.setTo(game.world.centerX, game.world.centerY*1.3);
        this.txtDesc.anchor.setTo(0.5,0.5);
        this.txtDesc.fontSize = 30;
        ...
        this.resistors.r0.position.setTo(game.world.centerX/1.5,game.world.centerY/1.75+50);
        this.r0 = this.game.add.text(game.world.centerX/1.5,game.world.centerY/1.55+50,"47 \u2126");
        ...
        this.resistors.r1.position.setTo(game.world.centerX/1.75,game.world.centerY/1.25+50);
        this.r1 = this.game.add.text(game.world.centerX/1.75,game.world.centerY/1.15+50,"22 k\u2126");
        ...
        this.resistors.r2.position.setTo(game.world.centerX,game.world.centerY/1.4+50);
        this.r2 = this.game.add.text(game.world.centerX,game.world.centerY/1.255+50,"1.5 k\u2126");
        ...
        this.resistors.r3.position.setTo(game.world.centerX*1.35,game.world.centerY/1.75+50);
        this.r3 = this.game.add.text(game.world.centerX*1.35,game.world.centerY/1.55+50,"330 k\u2126");
        ...
        this.resistors.r4.position.setTo(game.world.centerX*1.45,game.world.centerY/1.25+50);
        this.r4 = this.game.add.text(game.world.centerX*1.45,game.world.centerY/1.15+50,"1.5 M\u2126");
