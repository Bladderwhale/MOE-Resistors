...
demo.state4.prototype = {
    ...
    create: function(){
        ...
        this.resistors.r2.position.setTo(game.world.centerX,game.world.centerY/1.4);
         ...
         //Arrow
        this.arrow0 = game.add.sprite(this.resistors.r2.position.x,this.resistors.r2.position.y-30,'arrow0');
        ...
        this.a1 = game.add.text(this.resistors.r2.x-225,game.world.centerY-10,"1st \nBand");
        ...
        this.arrowhead1 = game.add.sprite(660,403,'arrow1');
        this.arrowhead1.angle = 50;
    
        this.a2 = game.add.text(this.resistors.r2.x-35,game.world.centerY-10,"2nd \nBand");
        ...
        this.arrowhead2 = game.add.sprite(709,409,'arrow1');
        this.arrowhead2.angle = -10;
        //3rd band
        this.a3 = game.add.text(this.resistors.r2.x+120,game.world.centerY-10,"3rd \nBand");
        ...
        this.arrowhead3 = game.add.sprite(757,420,'arrow1');
        this.arrowhead3.angle = -50;
      
        this.a4 = game.add.text(this.resistors.r2.x+300,game.world.centerY-10,"4th \nBand");
        ...
        this.arrowhead4 = game.add.sprite(812,420,'arrow1');
        ...
        //Next button
        addBtnNext(this);
        this.addbtnNext.events.onInputDown.add(function(){game.state.start('state5')},this);
